...
@section("content")
    <div class="container-fluid show">
        <div class="location bg-white mt-5 p-2">
            <p class="ps-2 h4 font-weight-bold"> <span class="text-secondary">Home <i class="fas fa-caret-right"></i></span> Show</p>
        </div>
        <div class="d-flex mt-5">
            <div class="show-image p-1 bg-white">
                <img src="http://127.0.0.1:8000/storage/photos/{{$data->image}}" alt="">
            </div>
            <div class="info ms-5 ps-5 pe-5 bg-white border">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active bg-white" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="tab-pane fade show active bg-white" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <h5>Հիմնական Նպատակներ</h5>
                            <div class="bg-light p-2">{!! $data->goal_content_hy !!}</div>
                        </div>
                        <div class="tab-pane fade show active bg-white mt-5" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <h5>Ինֆոմացիա</h5>
                            <div class="bg-light p-2">{!! $data->about_hy !!}</div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <div class="tab-pane fade show active bg-white" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <h5 class="mb-3">Цель Фонда</h5>
                            <div class="bg-light p-2">{!! $data->goal_content_ru !!}</div>
                        </div>
                        <div class="tab-pane fade show active bg-white pt-5" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <h5 class="mb-3">Информация</h5>
                            <div class="bg-light p-2">{!! $data->about_ru !!}</div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <div class="tab-pane fade show active bg-white" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <h5 class="mb-3">Goals of the foundation</h5>
                            <div class="bg-light p-2">{!! $data->goal_content_en !!}</div>
                        </div>
                        <div class="tab-pane fade show active bg-white pt-5" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
